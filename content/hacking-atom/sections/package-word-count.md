...
The default systax of the built-in package generator is Javascript.  You can change the syntax to Coffeescript by changing the selection on the package generator settings.
