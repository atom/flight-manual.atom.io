...
To run a Performance, open the Developer Tools with <kbd class="platform-mac">Alt+Cmd+I</kbd><kbd class="platform-windows platform-linux">Ctrl+Shift+I</kbd>. From there:

1. Click the Performance tab
2. Click on the record button
3. Carry out action
4. Click the record button again to stop
5. Right click on the profile graph, and then Save profile... as shown here:

![DevTools Profiler](../../images/cpu-profile.png)
